...
class MFCControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ServerHealthCheck = channel.unary_unary(
                '/MFCController/ServerHealthCheck',
                request_serializer=service__pb2.Empty.SerializeToString,
                response_deserializer=service__pb2.Empty.FromString,
                _registered_method=True)


class MFCControllerServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_MFCControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'MFCController', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('MFCController', rpc_method_handlers)
